  ...
  createClones() {
    ...
    for (let i = 0; i <= 6; i++) {
      ...
      if (i === 1) {
        ...
        this.sprinklesLowQClone.children[0].children[0].material.color.set(
          '#e0ff00'
        );
        this.sprinklesLowQClone.children[0].children[1].material.color.set(
          '#e0ff00'
        );
      }
      // caramel donut
...
const scrollTriggerAnims = () => {
  ...
  discoverTl
    ...
    .to('.donut-info circle', { autoAlpha: 1, stagger: 0.1, duration: 0.1 }, 0.2)
    ...
    .to('.donut-info circle', { autoAlpha: 0, stagger: 0.1, duration: 0.1 }, 1.1)
    .to(
      '.donut-info path',
